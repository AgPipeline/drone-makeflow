...
cp 'cache/cached_files_makeflow_list.json' 'cache/cached_files_makeflow_list.plotclip.json'
$HOME/cctools/bin/makeflow --jx canopy_cover_workflow.jx --jx-args env.json --jx-args cache/cached_files_makeflow_list.json $@
